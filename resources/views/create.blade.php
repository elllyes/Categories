    ...
    <div class="row justify-content-center ">
        <div class="row-cols-auto">
            <div class="card form-control">
                <div class="card-header form-control">{{ __('Create category') }}</div>

                <div class="card-body form-control">
                    <form method="POST" action="/create">
                        @csrf
                        <x-form.input name="name" label="Category" type="text" value="{{ old('name') }}"/>
                        <x-form.textarea name="short_description" label="Category short description"  value="{{ old('short_description') }}"/>
                        <x-form.tinymce-editor/>
                        <script>
                            function myFunction() {
                            var checkBox = document.getElementById("enabled");
                            var text = document.getElementById("published");
